...
public class UpdateEmployeeWithDependenciesCommand : IRequest<Unit>, IMapWith<Employee>, IMapWith<Passport>,
IMapWith<Department>
{
    ...
    {
        profile.CreateMap<UpdateEmployeeWithDependenciesCommand, Employee>()
        ...
        profile.CreateMap<UpdateEmployeeWithDependenciesCommand, Passport>()
            .ForMember(dest => dest.Type,
                opt => opt.MapFrom(src => src.PassportType))
            .ForMember(dest => dest.Number,
                opt => opt.MapFrom(src => src.PassportNumber));

        profile.CreateMap<UpdateEmployeeWithDependenciesCommand, Department>()
            .ForMember(dest => dest.Name,
