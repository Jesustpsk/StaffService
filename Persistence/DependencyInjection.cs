...
public static class DependencyInjection
{
    ...
    private static IServiceCollection AddDapperDbContext(this IServiceCollection services, string connectionString)
    {
        services.AddScoped<StaffServiceDbContext>(_ => new StaffServiceDbContext(connectionString));
